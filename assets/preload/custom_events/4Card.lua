...
function onUpdate()
    if (CardIsAllowedOnScreen == true) and (canAttackCard == true) and (getMouseX('camHUD') > 0 and getMouseX('camHUD') < 128) and (getMouseY('camHUD') > 582.5 and getMouseY('camHUD') < 720 and mouseReleased('left')) then
