function onCreate()
	if not lowQuality then
		...
		addAnimationByPrefix('CupheadStage2_BfGhost','Fly instance ','Fly instance ',12, false)
		addAnimationByPrefix('CupheadStage2_BfGhost','Stay instance ','Stay instance ',12, true)
		...
		addAnimationByPrefix('CupheadStage2_BfGhost2','Fly instance ','Fly instance ',12, false)
		addAnimationByPrefix('CupheadStage2_BfGhost2','Stay instance ','Stay instance ',12, true)
