...
function onCreate()
	...
	addAnimationByPrefix('Cuphead Hadoken','Hadolen instance ','Hadolen instance ',8, false)
	scaleObject('Cuphead Hadoken', 2.6, 2.6);	
	...
	scaleObject('Cuphead Hadoken Final', 2.6, 2.6);	
